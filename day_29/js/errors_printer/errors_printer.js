...
// used three times color a, four times color b, one time color h then one
// time color a...
...
// solution
const errorPrinter = (string) => {
    const availableLetters = 'abcdefghijklm'.split('');
    const errors = [...string].filter(elem => !availableLetters.includes(elem));
