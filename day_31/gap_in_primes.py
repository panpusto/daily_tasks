...
# ([193, 197] is also such a 4-gap primes between 130 and 200 
# but it's not the first pair)

# gap(6,100,110) --> nil or {0, 0} or ... : between 100 and 110 we have
# 101, 103, 107, 109 but 101-107 is not a 6-gap because there is 103 in between
# and 103-109 is not a 6-gap because there is 107in between.
...
class GapInPrimesBasicTests(unittest.TestCase):
    def test_search_first_gap(self):
